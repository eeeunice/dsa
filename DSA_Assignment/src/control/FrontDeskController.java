...
public class FrontDeskController {
    ...
    public String generateReceipt(int ticketNumber) {
        ...
        if (assignedRoom != null && !assignedRoom.trim().isEmpty()) {
            String hkStatus = HouseKeepingController.getInstance().getRoomStatus(assignedRoom);
        ...
        (assignedRoom,record.getFullName(),
                        "Occupied by "
                                + record.getFullName()
                                + " (Ticket: "
                                + ticketNumber
    ...
    public void notifyRoomCleaned(String roomId) {
        housekeepingNotifications.add("Room "
                        + roomId + " is cleaned and ready for the next check-in.");
    }
