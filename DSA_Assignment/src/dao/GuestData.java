...
public class GuestData {
    ...
    public ListInterface<Guest> initGuestData() {
        ...
        Guest g3 = new Guest(10000003, "min ling", 'M', "011-45678490", "Suite", 5);
        g3.setStatus("Served");

        Guest g4 = new Guest(10000004, "Eric Loo ", 'M', "011-27652348", "Presidential Suite", 3);
        g4.setStatus("Waiting");

        Guest g5 = new Guest(10000005, "lim", 'M', "011-67895423", "Double", 5);
        g5.setStatus("Waiting");

        Guest g6 = new Guest(10000006, "Mohamad bin abdullah", 'M', "012-4627290", "Suite", 10);
        g6.setStatus("Waiting");
        
        Guest g7 = new Guest(10000007, "Ong Zi YU", 'F', "011-24627096", "Presidential Suite", 7);
        g7.setStatus("Waiting");
        
        Guest g8 = new Guest(10000008, "Syamel Aiman", 'M', "014-5558890", "Suite", 10);
        g8.setStatus("Waiting");
        
        Guest g9 = new Guest(10000009, "Beh Bing Hong", 'M', "016-7620990", "Suite", 4);
        g9.setStatus("Waiting");
        
        Guest g10 = new Guest(10000010, "Tan Bee Choo", 'F', "011-88889232", "Double", 1);
